...
const api = {
  ...
  /**
   * Full-text search across every Markdown file in the workspace. `searchId` is
   * generated by the caller and echoed back so late responses can be dropped.
   */
  searchWorkspace: (
    options: SearchOptions & { searchId: string }
  ): Promise<SearchResult> => ipcRenderer.invoke(IPC.FS_SEARCH, options),
